...
( function( factory ) {
    ...
    Slick.prototype.buildDots = function() {
        ...
        if ( _.options.dots === true && _.slideCount > _.options.slidesToShow ) {
            ...
            var slidesLengthPlusOne = _.getDotCount() + 1
            $( ".slick-dots" ).append( "<div class='slide-numbers'></div>" )
            for ( i = 1; i <= slidesLengthPlusOne; i += 1 ) {
                $( ".slide-numbers" ).append( $( '<li />' ).html( "<span class='first-slide-number'>" + "0" + i + "</span>/<span class='all-slides-number'> " + "0" + slidesLengthPlusOne + "</span>" ) );
            }


            _.$dots.find( ".slide-numbers" ).find( 'li' ).first().addClass( 'slick-active' ).attr( 'aria-hidden', 'false' );
        }
    ...
    Slick.prototype.updateDots = function() {
        ...
        if ( _.$dots !== null ) {
            ...
            _.$dots
                ...
                .find( '.dot-caption' ).remove()
                .attr( 'aria-hidden', 'true' )

            _.$dots.find( ".slide-numbers" ).find( "li" ).hide()

            var slideText = $( ".slide-show" ).find( ".slick-current" ).find( ".slide-title" ).text()
            $( ".slick-dots" ).find( ".dot-caption" ).text( slideText );
            ...
            _.$dots
                ...
                .addClass( 'slick-active' )
                .prepend( "<span class='dot-caption'>" + slideText + "</span>" )
                .attr( 'aria-hidden', 'false' )
                .parent().find( ".slide-numbers" ).find( "li" ).eq( Math.floor( _.currentSlide / _.options.slidesToScroll ) ).show()
    ...
    $.fn.simpleLightbox = function( options ) {
        ...
        var touchDevice = ( 'ontouchstart' in window ),
            ...
            close = function() {
                ...
                $( '.sl-image img, .sl-overlay, .sl-close, .sl-navigation, .sl-counter' ).fadeOut( 'fast', function() {
